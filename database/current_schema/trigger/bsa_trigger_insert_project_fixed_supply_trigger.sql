  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "FCERNY"."BSA_TRIGGER_INSERT_PROJECT_FIXED_SUPPLY" 
...
/
ALTER TRIGGER "FCERNY"."BSA_TRIGGER_INSERT_PROJECT_FIXED_SUPPLY" ENABLE;