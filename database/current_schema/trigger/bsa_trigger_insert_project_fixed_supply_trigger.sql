  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "FRANKCERNY"."BSA_TRIGGER_INSERT_PROJECT_FIXED_SUPPLY" 
    ...
    BEGIN 
        ...
        END IF;
    END;
ALTER TRIGGER "FRANKCERNY"."BSA_TRIGGER_INSERT_PROJECT_FIXED_SUPPLY" ENABLE