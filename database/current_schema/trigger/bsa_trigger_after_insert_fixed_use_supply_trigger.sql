  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "DEV_WS"."BSA_TRIGGER_AFTER_INSERT_FIXED_USE_SUPPLY" 
...
ALTER TRIGGER "DEV_WS"."BSA_TRIGGER_AFTER_INSERT_FIXED_USE_SUPPLY" ENABLE