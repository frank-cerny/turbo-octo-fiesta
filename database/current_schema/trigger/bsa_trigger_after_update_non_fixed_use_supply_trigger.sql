  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "DEV_WS"."BSA_TRIGGER_AFTER_UPDATE_NON_FIXED_USE_SUPPLY" 
    ...
    END;
ALTER TRIGGER "DEV_WS"."BSA_TRIGGER_AFTER_UPDATE_NON_FIXED_USE_SUPPLY" ENABLE