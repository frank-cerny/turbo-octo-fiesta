  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "DEV_WS"."BSA_TRIGGER_INSERT_PROJECT_NON_FIXED_SUPPLY" 
...
ALTER TRIGGER "DEV_WS"."BSA_TRIGGER_INSERT_PROJECT_NON_FIXED_SUPPLY" ENABLE